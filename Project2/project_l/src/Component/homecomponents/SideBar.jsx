...
export default function Sidebar({ user = {} }) {
  return (
    <div
      className=" mt-4 m-3  rounded-5 shadow-sm "
      style={{
        position: "sticky",
        top: "95px", // Adjust this based on your header height
        height: "calc(100vh - 70px)", // Adjust for header space
        overflowY: "auto",
      }}
    >
      {/* User Profile Section - Card */}
      <div className="card shadow-sm border-2 rounded-4">
      ...
      <div className="card shadow-sm border-2 rounded-4 mt-3">
